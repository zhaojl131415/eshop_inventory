package com.zhao.eshop.inventory.controller;
...
import com.zhao.eshop.inventory.request.ProductInventoryCacheRefreshRequest;
import com.zhao.eshop.inventory.request.ProductInventoryDBUpdateRequest;
import com.zhao.eshop.inventory.request.Request;
import com.zhao.eshop.inventory.service.ProductInventoryService;
import com.zhao.eshop.inventory.service.RequestAsyncProcessService;
import com.zhao.eshop.inventory.vo.Response;
...
//		System.out.println("===========日志===========: 接收到更新商品库存的请求，商品id=" +  + "" + );
...
//				}
				...
				if(productInventory != null) {
					log.info("在200ms内读取到了redis中的库存缓存，商品id={}, 商品库存数量={}", productInventory.getProductId(), productInventory.getInventoryCnt());
